...
import { FileText, Plus, Upload, Search, History, Trash2 } from "lucide-react";
              ...
              {loading ? (
                      ...
                      <div className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        ...
                        <div className="flex flex-wrap gap-2 shrink-0">
                          ...
                          <Button
                            ...
                            onClick={() =>
                              handleDelete(spec.id, spec.displayTitle)
                            }
                          >
                ...
                <div className="text-center py-12 border-2 border-dashed rounded-xl border-border">
                  ...
                  <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
                    Upload an OpenAPI spec to explore endpoints and track
                    versions over time.
                  </p>
